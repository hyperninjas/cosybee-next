...
export default function ReadyToReduce() {
  return (
    <section className="max-w-360 mx-auto px-6 pb-20 sm:px-10 lg:px-30 lg:py-25">
      <div className="mx-auto relative flex max-w-360 flex-col items-center gap-8 rounded-3xl bg-[#F7F7F7] p-8 shadow-[0_30px_30px_-15px_rgba(0,0,0,0.15)] sm:p-10 lg:flex-row lg:gap-12 lg:p-14">
        ...
        <div className="flex-1 md:text-center min-[1200px]:text-left">
          ...
          <h2 className="text-2xl font-extrabold leading-tight text-black sm:text-3xl min-[1200px]:text-[40px]">
