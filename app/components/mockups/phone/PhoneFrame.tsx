...
export default function PhoneFrame({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[1.9rem] bg-surface pb-2">
        {/* dynamic island */}
        <div className="absolute left-1/2 top-1.5 z-10 h-3.5 w-14 -translate-x-1/2 rounded-full bg-black" />

        {/* status bar */}
        <div className="flex items-center justify-between px-4 pt-1 text-[10px] font-semibold text-foreground">
          <span>9:41</span>
