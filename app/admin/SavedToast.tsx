...
export default function SavedToast() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-xl bg-[#1b1b1b] px-4 py-3 text-sm text-white shadow-lg">
      ...
      {published && (
        <Link
          href={`/${saved}`}
          target="_blank"
          className="font-semibold text-[#FFB4A8] underline"
        >
          View post
        </Link>
      )}
