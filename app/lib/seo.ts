...
/**
 * Default social-share image: the dynamic, on-brand 1200×630 card generated by
 * app/opengraph-image.tsx. `metadataBase` (set in the root layout) resolves the
 * relative URL to an absolute one for crawlers.
 */
