...
const CSP_REPORT_ONLY = [
  ...
  "script-src 'self' 'unsafe-inline' https://app.consently.net https://www.google.com https://www.gstatic.com https://www.googletagmanager.com https://www.clarity.ms https://scripts.clarity.ms",
  "img-src 'self' data: blob: https://eb-api.technext.it https://energiebee.s3.eu-west-2.amazonaws.com https://www.google.com https://www.googletagmanager.com https://*.google-analytics.com https://c.bing.com https://c.clarity.ms",
  // Clarity uploads replay data to a regional *.clarity.ms host and syncs its
  // MUID cookie against c.bing.com. Consently fetches its banner config and
  // vendor list from api.consently.net.
  "connect-src 'self' https://app.consently.net https://api.consently.net https://www.google.com https://www.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://eb-api.technext.it https://*.clarity.ms https://c.bing.com",
